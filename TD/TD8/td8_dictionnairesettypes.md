...
##Q4.
Dans un fichier apart, reprendre l'exercice et reécrire toutes les fonctions en rajoutant les annotation de type. A chaque exécution, Testez votre code avec mypy.
